...
public class ConfigClientV2 {
    private static final Logger logger = LoggerFactory.getLogger(ConfigClientV2.class);

    private CloseableHttpClient httpClient;
    private RequestConfig requestConfig;

    public ConfigClientV2() {
    ...
    public static void main(String[] args) {
        ConfigClientV2 configClient = new ConfigClientV2();
        configClient.longPolling("http://127.0.0.1:8851/notifications/v2", "v2");
    }
}
